...
export default function Navbar() {
  ...
  onMount(() => {
    ...
    window.addEventListener("stoppage:open-auth-modal", handleOpenAuthModal);

    onCleanup(() => {
      isDisposed = true;
      window.removeEventListener("stoppage:open-auth-modal", handleOpenAuthModal);
    });
