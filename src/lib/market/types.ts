...
export interface EventMatchParticipantResponse {
  name: string;
...
export interface EventMatchupResponse {
  sport_slug: string;
  competition_name?: string | null;
  round_name?: string | null;
  fixture_id?: string | null;
  status: string;
  home: EventMatchParticipantResponse;
  away: EventMatchParticipantResponse;
}
...
export interface PublicEventTeaserResponse {
  ...
  tag_slugs: string[];
  image_url: string | null;
  matchup?: EventMatchupResponse | null;
  summary: string | null;
  featured: boolean;
  breaking: boolean;
  neg_risk: boolean;
